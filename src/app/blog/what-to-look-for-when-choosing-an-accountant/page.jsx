...
<p><!-- /wp:paragraph --></p>		
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"What to look for when choosing an accountant | Taxaccolega","description":"What to look for when choosing an accountant image A business needs an accountant as early as at the planning stage. I always advise businesses to hire an acco…","datePublished":"2022-09-13 11:18:45","dateModified":"2022-09-13 11:18:45","author":{"@type":"Person","name":"Shehriyar Lateef"},"publisher":{"@type":"Organization","name":"Taxaccolega"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://www.taxaccolega.co.uk/blog/what-to-look-for-when-choosing-an-accountant/"}}) }} />
      <ContactSection />
    </div>
  );
}
