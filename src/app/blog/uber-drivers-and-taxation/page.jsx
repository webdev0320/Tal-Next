...
<p><!-- /wp:paragraph --></p>		
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Uber Drivers and taxation | Taxaccolega","description":"Uber Drivers and taxation If you are working for Uber you are not considered their employees. You are working as a self employed person as you set your own wor…","datePublished":"2022-06-12 11:51:49","dateModified":"2022-06-12 11:51:49","author":{"@type":"Person","name":"Shehriyar Lateef"},"publisher":{"@type":"Organization","name":"Taxaccolega"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://www.taxaccolega.co.uk/blog/uber-drivers-and-taxation/"}}) }} />
      <ContactSection />
    </div>
  );
}
