...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/2020/07/holdover-relief.jpg" }],
  },
  twitter: {
    card: 'summary_large_image',
    title: "Holdover Relief Explained – Capital Gains Tax Guide UK | Taxaccolega",
    description: "Holdover Relief I am selling my business to my friend will holdover relief apply to me? If you are eligible for gift holdover relief or not depends on all indi…",
    images: ["/images/2020/07/holdover-relief.jpg"],
  },
};
  ...
  return (
    <div className="blog-post-page bg-light">
      ...
      <div className="container mt-n5" style={{ marginTop: '-2rem' }}>
        <img src="/images/2020/07/holdover-relief.jpg" alt="Holdover Relief Explained – Capital Gains Tax Guide UK" className="w-100 rounded shadow-sm" style={{ maxHeight: '450px', objectFit: 'cover' }} />
      </div>
