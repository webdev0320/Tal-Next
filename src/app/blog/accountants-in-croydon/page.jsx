...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/2022/05/accountant-in-Croydon.jpg" }],
  },
  twitter: {
    card: 'summary_large_image',
    title: "Accountants in Croydon | Taxaccolega",
    description: "Accountants in Croydon Why do I need an accountant ? You need an accountant not only because they will do your accounts but having an accountant who is dependa…",
    images: ["/images/2022/05/accountant-in-Croydon.jpg"],
  },
};
  ...
  return (
    <div className="blog-post-page bg-light">
      ...
      <div className="container mt-n5" style={{ marginTop: '-2rem' }}>
        <img src="/images/2022/05/accountant-in-Croydon.jpg" alt="Accountants in Croydon" className="w-100 rounded shadow-sm" style={{ maxHeight: '450px', objectFit: 'cover' }} />
      </div>
