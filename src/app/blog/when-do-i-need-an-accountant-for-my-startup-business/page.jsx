...
<p><!-- /wp:paragraph --></p>		
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"When do I need an accountant for my startup business? | Taxaccolega","description":"When do I need an accountant for my startup business? You are starting a business because you have a brilliant idea which you want to commercialize. You should…","datePublished":"2022-02-13 12:16:51","dateModified":"2022-02-13 12:16:51","author":{"@type":"Person","name":"Shehriyar Lateef"},"publisher":{"@type":"Organization","name":"Taxaccolega"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://www.taxaccolega.co.uk/blog/when-do-i-need-an-accountant-for-my-startup-business/"}}) }} />
      <ContactSection />
    </div>
  );
}
