...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/2021/05/payment-on-account.jpg" }],
  },
  twitter: {
    card: 'summary_large_image',
    title: "Sole Trader Tax: July Payment on Account Explained | Taxaccolega",
    description: "Tax due in July as a sole trader payment on account If you are self-employed running your own business as a sole trader you will have to pay your income tax th…",
    images: ["/images/2021/05/payment-on-account.jpg"],
  },
};
  ...
  return (
    <div className="blog-post-page bg-light">
      ...
      <div className="container mt-n5" style={{ marginTop: '-2rem' }}>
        <img src="/images/2021/05/payment-on-account.jpg" alt="Sole Trader Tax: July Payment on Account Explained" className="w-100 rounded shadow-sm" style={{ maxHeight: '450px', objectFit: 'cover' }} />
      </div>
