        ...
        <div className="container">
                ...
                <div key={idx} className="col-lg-4 col-md-6">
                  <div className={`card h-100 border-0 shadow-sm ${tier.isPopular ? 'border-brand-orange' : ''}`} style={{ transition: 'transform 0.3s', position: 'relative' }}>
                    ...
                    <div className="card-footer bg-white border-0 p-4 text-center">
                      <Link href="/contact" className={`btn w-100 ${tier.isPopular ? 'text-white' : 'btn-outline-dark'}`} style={tier.isPopular ? { background: '#e07b39', fontWeight: 600 } : { fontWeight: 600 }}>
                        Choose {tier.name}
                      </Link>
                    </div>
                  </div>
          ...
          <div className="row justify-content-center mt-5 text-center">
            <div className="col-lg-8">
              ...
              <Link href="/contact" className="btn px-4 py-2 text-white" style={{ background: '#e07b39', fontWeight: 600 }}>
                Contact Us Today
              </Link>
            </div>
          </div>
