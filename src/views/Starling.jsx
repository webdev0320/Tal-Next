...
const Starling = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Starling Bank Accountants', active: true },
  ];
  ...
  const sections = [
  {
    "title": "Starling",
    "paragraphs": [
      "Business Excellence with Starling Bank",
  ...
  {
    "title": "Why Choose Starling Bank for Your Business?",
    "paragraphs": [
      "Opting for Starling Bank is a strategic decision for your business. As a leading digital bank, Starling offers a range of innovative features designed to streamline your financial management. With a Starling business account, you'll experience effortless online banking, including real-time transaction notifications, easy expense categorization, and integration with popular accounting software like Xero.",
      "Starling's intuitive mobile app empowers you to handle payments, make transfers, and manage your finances on the go. This provides a convenient and time-saving solution for busy entrepreneurs. Choose Starling Bank to embrace cutting-edge banking technology, enhance financial efficiency, and focus on what truly matters - growing your business."
    ],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Starling Bank Accountants"
        subtitle="Award-Winning Accounting Services for Starling Bank Business Customers"
