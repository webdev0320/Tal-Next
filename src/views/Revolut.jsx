...
const Revolut = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Revolut Business Accountants', active: true },
  ];
  ...
  const sections = [
  {
    "title": "Revolut",
    "paragraphs": [
      "Your Path to Financial Innovation",
  ...
  {
    "title": "Why Choose Revolut Bank for Your Business?",
    "paragraphs": [
      "Selecting Revolut Bank for your business is a decision backed by innovation and convenience. With Revolut's cutting-edge digital banking platform, your business gains a powerful financial management ally. Revolut offers multi-currency accounts, expense tracking, and seamless integration with popular accounting software.",
      "Their user-friendly app simplifies international transactions, saving you time and money on currency exchange. Moreover, real-time expense notifications and customizable spending limits provide unparalleled control. Whether you're a small startup or a growing enterprise, Revolut's business banking solutions are designed to adapt to your needs. This ensures financial efficiency and flexibility for your business operations."
    ],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Revolut Business Accountants"
        subtitle="Chartered Accountants Who Integrate with Your Revolut Business Account"
                  ...
                  <div className="col-lg-5 order-2 order-lg-1">
                    <div className="p-2 border rounded-4 shadow-lg bg-white">
                      <img
                        ...
                        alt="Revolut Business Accountants"
