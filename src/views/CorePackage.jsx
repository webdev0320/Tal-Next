...
const CorePackage = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Core Accounting Package', active: true },
  ];
  ...
  return (
    <div>
      <PageHero
        title="Core Accounting Package"
        subtitle="Our All-Inclusive Accounting Package — Everything Your Business Needs"
      ...
      <Partners />
      <ContactForm source="CorePackage" />
      <ReviewsSlider />
    </div>
  );
};
