...
const HairdressersBeautyBarbers = () => {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Hairdressers & Beauty Accountants', active: true },
  ];

  const sections = [
  {
    "title": "Hairdressers, Beauty & Barbers",
    "paragraphs": [
  ...
  {
    "title": "How do we help for Hairdressers, Beauty & Barbers?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Hairdressers & Beauty Accountants"
        subtitle="Tailored Accounting & Tax for Hair Salons, Beauty Therapists and Barbers"
                  ...
                  <div className="col-lg-5 order-2 order-lg-1">
                    <div className="p-2 border rounded-4 shadow-lg bg-white">
                      <img
                        ...
                        alt="Hairdressers & Beauty Accountants"
      ...
      <Partners />
      <ContactForm source="HairdressersBeautyBarbers" />
      <ReviewsSlider />
    </div>
  );
};

export default HairdressersBeautyBarbers;
