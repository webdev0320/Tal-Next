...
const Spvs = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'SPV Accountants', active: true },
  ];
  ...
  return (
    <div>
      <PageHero
        title="SPV Accountants"
        subtitle="Expert Accounting & Tax Planning for Special Purpose Vehicles and Property SPVs"
