...
const MediaCreativeIndustries = () => {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Media & Creative Industry Accountants', active: true },
  ];
  ...
  {
    "title": "How do we help For Sole Traders ?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Media & Creative Industry Accountants"
        subtitle="Tax-Efficient Accounting for Creatives, Freelancers & Media Professionals"
                  ...
                  <div className="col-lg-5 order-2 order-lg-1">
                    <div className="p-2 border rounded-4 shadow-lg bg-white">
                      <img
                        ...
                        alt="Media & Creative Industry Accountants"
      ...
      <Partners />
      <ContactForm source="MediaCreativeIndustries" />
      <ReviewsSlider />
    </div>
  );
};

export default MediaCreativeIndustries;
