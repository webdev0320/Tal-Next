            ...
            <div className="col-lg-8 text-center text-lg-start">
              ...
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb justify-content-center justify-content-lg-start mb-0 small" style={{ background: 'transparent' }}>
                  ...
                  <li className="breadcrumb-item"><Link href="/taxation" className="text-decoration-none text-brand-orange">Taxation</Link></li>
          ...
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-7 order-1 order-lg-2">
              ...
              <p className="text-secondary fw-semibold bg-white p-3 rounded shadow-sm border-start border-brand-orange border-4">
                This mechanism relies entirely on accurate bookkeeping. When underlying <Link href="/accounts/bookkeeping-services/" className="text-brand-orange text-decoration-none">bookkeeping services for small businesses</Link> are kept up to date, VAT reporting stays simple and secure.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-7 order-1 order-lg-2">
              ...
              <p className="text-secondary" style={{ lineHeight: 1.8 }}>
                Proper initial structure is especially important when your business is also managing <Link href="/taxation/company-tax-return-accountants" className="text-brand-orange text-decoration-none">corporation tax services</Link>, where VAT treatment directly affects profit calculations and allowable expenses.
              </p>
            </div>
          </div>
        </div>
