...
const Jewellers = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Jewellers Accountants', active: true },
  ];
  ...
  {
    "title": "How do we help for Jewellers?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Jewellers Accountants"
        subtitle="Specialist Financial & Tax Services for the UK Jewellery Trade"
