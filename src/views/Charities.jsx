...
const Charities = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <img src="/images/2023/08/Untitled-design-6.png" alt="Charity Support" className="w-full max-w-2xl mb-8" />
      ...
      <img src="/images/2023/06/fooddrive.webp" alt="Food Drive" className="w-full mb-12" />
