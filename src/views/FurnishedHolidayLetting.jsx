...
const FurnishedHolidayLetting = () => {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Furnished Holiday Letting Accountants', active: true },
  ];

  const sections = [
  {
    "title": "Furnished Holiday letting",
    "paragraphs": [
  ...
  {
    "title": "How do we help for Furnished Holiday letting?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Furnished Holiday Letting Accountants"
        subtitle="Expert FHL Tax Planning & HMRC Compliance for Holiday Let Owners"
                  ...
                  <div className="col-lg-5 order-2 order-lg-1">
                    <div className="p-2 border rounded-4 shadow-lg bg-white">
                      <img
                        ...
                        alt="Furnished Holiday Letting Accountants"
      ...
      <Partners />
      <ContactForm source="FurnishedHolidayLetting" />
      <ReviewsSlider />
    </div>
  );
};

export default FurnishedHolidayLetting;
