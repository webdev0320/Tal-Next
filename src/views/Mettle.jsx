...
const Mettle = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Mettle Bank Accountants', active: true },
  ];
  ...
  const sections = [
  {
    "title": "Mettle",
    "paragraphs": [
      "Empowering Your Business Finances with Mettle Bank",
  ...
  {
    "title": "Why Choose Mettle Bank for Your Business?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Mettle Bank Accountants"
        subtitle="Chartered Accountants Working Alongside Your Mettle Business Account"
      ...
      <Partners />
      <ContactForm source="Mettle" />
      <ReviewsSlider />
    </div>
  );
};

export default Mettle;
