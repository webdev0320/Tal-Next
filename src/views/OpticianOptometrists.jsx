...
const OpticianOptometrists = () => {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Opticians & Optometrists Accountants', active: true },
  ];

  const sections = [
  {
    "title": "Optician & Optometrists",
    "paragraphs": [
  ...
  {
    "title": "How do we help for Optician & Optometrists?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Opticians & Optometrists Accountants"
        subtitle="Specialist Accounting & Tax Planning for Opticians and Optometry Practices"
                  ...
                  <div className="col-lg-5 order-2 order-lg-1">
                    <div className="p-2 border rounded-4 shadow-lg bg-white">
                      <img
                        ...
                        alt="Opticians & Optometrists Accountants"
      ...
      <Partners />
      <ContactForm source="OpticianOptometrists" />
      <ReviewsSlider />
    </div>
  );
};

export default OpticianOptometrists;
