...
const ConstructionBuilders = () => {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Construction & Builders Accountants', active: true },
  ];
  ...
  return (
    <div>
      <PageHero
        title="Construction & Builders Accountants"
        subtitle="CIS, VAT & Accounting Expertise for Builders and Construction Companies"
                  ...
                  <div className="col-lg-5 order-2 order-lg-1">
                    <div className="p-2 border rounded-4 shadow-lg bg-white">
                      <img
                        ...
                        alt="Construction & Builders Accountants"
      ...
      <Partners />
      <ContactForm source="ConstructionBuilders" />
      <ReviewsSlider />
    </div>
  );
};

export default ConstructionBuilders;
