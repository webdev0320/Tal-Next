...
const Anna = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Anna Money Accountants', active: true },
  ];
  ...
  const sections = [
  {
    "title": "Anna",
    "paragraphs": [
      "Empowering Your Financial Success with Anna Bank",
  ...
  {
    "title": "Why Choose Anna Bank for Your Business?",
    "paragraphs": [
      "Choosing Annea Bank as your business's bank opens up in a new era of financial efficiency and convenience. With Anna Bank's tailored solutions, your business gains a reliable partner dedicated to simplifying your financial operations. Our user-friendly digital banking platform empowers you to manage transactions, track expenses, and streamline your finances seamlessly.",
  ...
  return (
    <div>
      <PageHero
        title="Anna Money Accountants"
        subtitle="Seamless Accounting Integration with Anna Money for UK Small Businesses"
