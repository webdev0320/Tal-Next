...
const Dropshipping = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Dropshipping Accountants', active: true },
  ];
  ...
  {
    "title": "How do we help for Dropshipping?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Dropshipping Accountants"
        subtitle="Tax-Efficient Accounting Solutions for UK Dropshipping Businesses"
      ...
      <Partners />
      <ContactForm source="Dropshipping" />
      <ReviewsSlider />
    </div>
  );
};
