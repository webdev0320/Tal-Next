...
const HotelsRestaurantsBars = () => {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Hotels, Restaurants & Bars Accountants', active: true },
  ];
  ...
  {
    "title": "How do we help for Hotels, Restaurants & Bars?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="Hotels, Restaurants & Bars Accountants"
        subtitle="Specialist Accounting & Tax Services for the Hospitality Sector"
                  ...
                  <div className="col-lg-5 order-2 order-lg-1">
                    <div className="p-2 border rounded-4 shadow-lg bg-white">
                      <img
                        ...
                        alt="Hotels, Restaurants & Bars Accountants"
      ...
      <Partners />
      <ContactForm source="HotelsRestaurantsBars" />
      <ReviewsSlider />
    </div>
  );
};

export default HotelsRestaurantsBars;
