...
const Woocommerce = () => {
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'WooCommerce Accountants', active: true },
  ];
  ...
  {
    "title": "How do we help for Woocommerce?",
    "paragraphs": [],
    "bullets": [],
    "faqs": []
  },
  ...
  return (
    <div>
      <PageHero
        title="WooCommerce Accountants"
        subtitle="Accounting, VAT & Tax Services Tailored for WooCommerce Store Owners"
      ...
      <Partners />
      <ContactForm source="Woocommerce" />
      <ReviewsSlider />
    </div>
  );
};
