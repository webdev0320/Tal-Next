            ...
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    ...
                    answer={"You must register for VAT if your VAT taxable turnover exceeds the current registration threshold (currently Ã‚Â£90,000) within a 12-month period, or if you expect to exceed it in the next 30 days."} 
                    isOpen={openFaq === 0}
