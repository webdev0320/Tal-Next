          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-8 text-center text-lg-start">
              ...
              <p className="lead text-white-50 mb-4" style={{ maxWidth: '680px', fontSize: '1.1rem', lineHeight: 1.6 }}>
                {"Maximise Tax Reliefs on Early-Stage Investments"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0 small">
              ...
              <li className="breadcrumb-item active text-secondary">SEIS & EIS Tax Relief</li>
            </ol>
          </nav>
        </div>
      </div>
          ...
          <div className="row g-4">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"The Seed Enterprise Investment Scheme (SEIS) and Enterprise Investment Scheme (EIS) offer generous income tax reliefs, CGT deferral, and loss relief to investors in qualifying early-stage UK companies."}
              </p>
              
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"Taxaccolega advises both investors and investee companies on SEIS and EIS eligibility, advance assurance applications, compliance, and the interaction of these schemes with existing tax positions."}
              </p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"What relief does SEIS offer investors?"} 
                    answer={"SEIS investors can claim 50% income tax relief on investments up to ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£200,000 per tax year. Gains on disposal after 3 years are also exempt from CGT. Loss relief is available if the investment fails."} 
                    isOpen={openFaq === 0}
                    onClick={() => setOpenFaq(openFaq === 0 ? null : 0)}
                  />
                
                  <FAQItem 
                    question={"What is the difference between SEIS and EIS?"} 
                    answer={"SEIS targets very early-stage companies (up to 3 years old, fewer than 25 employees, less than ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£350k raised). EIS covers later-stage companies and allows larger investments (up to ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£1m/ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£2m) with 30% income tax relief."} 
                    isOpen={openFaq === 1}
