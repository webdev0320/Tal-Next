...
export default function InheritanceTaxPlanningAdvisors() {
          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-8 text-center text-lg-start">
              ...
              <p className="lead text-white-50 mb-4" style={{ maxWidth: '680px', fontSize: '1.1rem', lineHeight: 1.6 }}>
                {"Expert IHT Advisory from Taxaccolega's Chartered Accountants"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0 small">
              ...
              <li className="breadcrumb-item active text-secondary">Inheritance Tax Planning Advisors</li>
            </ol>
          </nav>
        </div>
      </div>
          ...
          <div className="row g-4">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"Our chartered accountants and tax planning advisors have deep expertise in Inheritance Tax mitigation, trust planning, and intergenerational wealth transfer strategies."}
              </p>
              
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"We work closely with your solicitor and financial advisors to build a comprehensive, long-term IHT plan that integrates your will, trust structures, lifetime gifting, and pension planning."}
              </p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"When should I start IHT planning?"} 
                    answer={"IHT planning is most effective when started early. The 7-year rule for gifts means that planning done today can remove significant assets from your estate by the time they are needed."} 
                    isOpen={openFaq === 0}
                    onClick={() => setOpenFaq(openFaq === 0 ? null : 0)}
                  />
                
                  <FAQItem 
                    question={"Do you work with solicitors on IHT planning?"} 
                    answer={"Yes. We collaborate closely with your legal advisors to ensure your will, trusts, and lifetime giving strategies are fully aligned and legally robust."} 
                    isOpen={openFaq === 1}
