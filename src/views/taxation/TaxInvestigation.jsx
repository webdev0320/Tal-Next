          ...
          <div className="row g-5">
            <div className="col-lg-7">
              ...
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"Tax investigation insurance covers the professional fees involved in handling an HMRC enquiry. At Taxaccolega, we provide both the insurance arrangement and the specialist defence Ã¢â‚¬â€ so you have a single, experienced team managing your case from start to finish."}
              </p>
            ...
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    ...
                    answer={"It covers professional fees charged by your accountant for responding to HMRC Ã¢â‚¬â€ including correspondence, document preparation, and representation. It does not cover the tax, interest, or penalties themselves."} 
                    isOpen={openFaq === 0}
