...
export default function SeisTaxRelief() {
          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-8 text-center text-lg-start">
              ...
              <p className="lead text-white-50 mb-4" style={{ maxWidth: '680px', fontSize: '1.1rem', lineHeight: 1.6 }}>
                {"Expert Advice on Seed Enterprise Investment Scheme Relief"}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row g-4">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"SEIS and EIS offer some of the most generous tax reliefs in the UK tax code, designed to encourage private investment into early-stage and growth businesses."}
              </p>
              
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"Our advisors help investors structure their portfolios tax-efficiently using SEIS, EIS, and VCT schemes, and assist qualifying companies in obtaining HMRC advance assurance and issuing compliant certificates to investors."}
              </p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"How do I know if my investment qualifies for SEIS?"} 
                    answer={"The company must have traded for less than 3 years, have fewer than 25 full-time employees, assets under ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£350,000 before the investment, and carry out a qualifying trade. HMRC advance assurance confirms eligibility."} 
                    isOpen={openFaq === 0}
                    onClick={() => setOpenFaq(openFaq === 0 ? null : 0)}
                  />
                
                  <FAQItem 
                    question={"Can I carry back SEIS relief to a previous tax year?"} 
                    answer={"Yes. Up to half your SEIS investment can be carried back to the previous tax year, allowing you to claim relief against the previous year's income tax liability."} 
                    isOpen={openFaq === 1}
