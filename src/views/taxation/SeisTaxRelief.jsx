            ...
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    ...
                    answer={"The company must have traded for less than 3 years, have fewer than 25 full-time employees, assets under Ã‚Â£350,000 before the investment, and carry out a qualifying trade. HMRC advance assurance confirms eligibility."} 
                    isOpen={openFaq === 0}
