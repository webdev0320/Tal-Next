...
export default function LetProperty() {
          ...
          <div className="row g-4">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"The HMRC Let Property Campaign allows residential landlords to voluntarily disclose undeclared rental income and bring their tax affairs up to date under favourable penalty terms."}
              </p>
              
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"At Taxaccolega, we guide landlords through every stage of the Let Property Campaign disclosure ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â from calculating historic liabilities and preparing the disclosure pack to liaising directly with HMRC on your behalf."}
              </p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"What is the Let Property Campaign?"} 
                    answer={"It is an ongoing HMRC amnesty allowing residential landlords to disclose previously unreported rental income with reduced penalties compared to a prompted investigation."} 
                    isOpen={openFaq === 0}
                    onClick={() => setOpenFaq(openFaq === 0 ? null : 0)}
                  />
                
                  <FAQItem 
                    question={"How far back can HMRC investigate rental income?"} 
                    answer={"Up to 20 years for deliberate non-compliance, 6 years for careless mistakes, and 4 years for innocent errors. Voluntary disclosure significantly reduces penalty exposure."} 
                    isOpen={openFaq === 1}
