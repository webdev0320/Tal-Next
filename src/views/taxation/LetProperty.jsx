          ...
          <div className="row g-5">
            <div className="col-lg-7">
              ...
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"At Taxaccolega, we guide landlords through every stage of the Let Property Campaign disclosure Ã¢â‚¬â€ from calculating historic liabilities and preparing the disclosure pack to liaising directly with HMRC on your behalf."}
              </p>
