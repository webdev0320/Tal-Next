          ...
          <div className="row g-5">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"A specialist Capital Gains Tax accountant ensures you pay only the tax you legally owe, claim every available relief, and meet all HMRC reporting deadlines Ã¢â‚¬â€ including the 60-day residential property window."}
              </p>
            ...
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    ...
                    answer={"You need specialist advice whenever you are selling a second property, shares above the exempt amount, a business, or any high-value asset. Early advice Ã¢â‚¬â€ before the disposal Ã¢â‚¬â€ can save significant amounts in tax."} 
                    isOpen={openFaq === 0}
