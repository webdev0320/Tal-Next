          ...
          <div className="row g-4">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"The Worldwide Disclosure Facility (WDF) allows taxpayers to voluntarily correct offshore tax irregularities before HMRC escalates. International data-sharing agreements now automatically share bank and financial details with HMRC, making voluntary disclosure the safest path."}
              </p>
              
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"At Taxaccolega, we support property owners, non-UK residents, and investors in bringing their offshore affairs under control through the WDF process. Contact us today to discuss your options confidentially."}
              </p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"What is the Worldwide Disclosure Facility?"} 
                    answer={"The WDF is an HMRC disclosure route for taxpayers with undisclosed offshore income, gains, or assets. Making a voluntary disclosure before HMRC acts results in significantly lower penalties."} 
                    isOpen={openFaq === 0}
                    onClick={() => setOpenFaq(openFaq === 0 ? null : 0)}
                  />
                
                  <FAQItem 
                    question={"How do I start a Worldwide Disclosure?"} 
                    answer={"You must register for the WDF through HMRC Online and then submit a full disclosure of offshore tax liabilities within 90 days. Our team manages the entire process on your behalf."} 
                    isOpen={openFaq === 1}
