          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-8 text-center text-lg-start">
              ...
              <p className="lead text-white-50 mb-4" style={{ maxWidth: '680px', fontSize: '1.1rem', lineHeight: 1.6 }}>
                {"Minimise IHT and Protect Your Estate"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0 small">
              ...
              <li className="breadcrumb-item active text-secondary">Estate Tax Planning</li>
            </ol>
          </nav>
        </div>
      </div>
          ...
          <div className="row g-4">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"Estate tax planning is about more than Inheritance Tax. It involves structuring assets, coordinating wills and trusts, and planning lifetime gifts to ensure your estate passes to your beneficiaries as intact as possible."}
              </p>
              
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"Taxaccolega's advisors help you understand your current IHT exposure, identify planning opportunities, and implement strategies proportionate to your estate value and family circumstances."}
              </p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"What counts as part of my estate for IHT?"} 
                    answer={"Your estate includes all property, savings, investments, and personal possessions you own at the date of death. Certain trusts and gifts made within 7 years may also be included."} 
                    isOpen={openFaq === 0}
                    onClick={() => setOpenFaq(openFaq === 0 ? null : 0)}
                  />
                
                  <FAQItem 
                    question={"Are pensions included in my estate?"} 
                    answer={"Defined contribution pension funds are generally outside your estate for IHT purposes, making pensions a useful vehicle for intergenerational wealth transfer."} 
                    isOpen={openFaq === 1}
