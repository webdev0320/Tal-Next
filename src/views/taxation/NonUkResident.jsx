          ...
          <div className="row g-5">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"Non-UK residents with UK income sources — rental property, employment, pensions, or investments — have specific HMRC reporting obligations that are easily misunderstood."}
              </p>
            ...
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    ...
                    answer={"The NRLS requires UK letting agents (or tenants paying rent over £100/week) to deduct basic rate tax from rental payments unless HMRC approves the landlord to receive rent gross."} 
                    isOpen={openFaq === 1}
