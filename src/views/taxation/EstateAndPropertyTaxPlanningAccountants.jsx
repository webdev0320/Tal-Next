...
export default function EstateAndPropertyTaxPlanningAccountants() {
          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-8 text-center text-lg-start">
              ...
              <h1 className="display-4 fw-bold text-white mb-3" style={{ fontFamily: "'Outfit', sans-serif" }}>
                {"Estate & Property Tax Planning Accountants"}
              </h1>
              <p className="lead text-white-50 mb-4" style={{ maxWidth: '680px', fontSize: '1.1rem', lineHeight: 1.6 }}>
                {"Specialist Advisors for Property Investors and Estates"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0 small">
              ...
              <li className="breadcrumb-item active text-secondary">Estate & Property Tax Planning Accountants</li>
            </ol>
          </nav>
        </div>
      </div>
          ...
          <div className="row g-4">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"Our estate and property tax planning accountants combine deep expertise across IHT, CGT, income tax, and SDLT to deliver holistic tax advice for property-owning clients."}
              </p>
              
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"Whether you are building a buy-to-let portfolio, planning to pass assets to your children, or navigating a complex estate, Taxaccolega provides joined-up advice that considers all the taxes at play."}
              </p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"Do I need both a solicitor and an accountant for estate planning?"} 
                    answer={"Yes. Solicitors draft the legal documents (wills, trusts, deeds), while accountants calculate the tax implications and design the most efficient structure. We work alongside your legal advisors."} 
                    isOpen={openFaq === 0}
                    onClick={() => setOpenFaq(openFaq === 0 ? null : 0)}
                  />
                
                  <FAQItem 
                    question={"How is rental income taxed in an estate context?"} 
                    answer={"Rental income continues to be assessed on the beneficial owner. Where properties are held in trust, the trustees pay income tax at the trust rate (45% for discretionary trusts)."} 
                    isOpen={openFaq === 1}
