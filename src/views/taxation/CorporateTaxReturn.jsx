        ...
        <div className="container px-4">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0 small">
              ...
              <li className="breadcrumb-item active text-secondary">Company Tax Return Accountants</li>
            </ol>
          </nav>
        </div>
      </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"When is a Company Tax Return due?"} 
                    answer={"The CT600 must be filed within 12 months of the end of your accounting period. Corporation Tax itself is due nine months and one day after the accounting period ends."} 
                    isOpen={openFaq === 0}
                  ...
                  <FAQItem 
                    ...
                    answer={"Capital allowances let companies deduct the cost of qualifying capital expenditure from taxable profits, reducing the corporation tax bill. The Annual Investment Allowance (AIA) currently stands at ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£1 million."} 
                    isOpen={openFaq === 1}
