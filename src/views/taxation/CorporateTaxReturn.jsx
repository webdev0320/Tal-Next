            ...
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    ...
                    answer={"Capital allowances let companies deduct the cost of qualifying capital expenditure from taxable profits, reducing the corporation tax bill. The Annual Investment Allowance (AIA) currently stands at Ã‚Â£1 million."} 
                    isOpen={openFaq === 1}
