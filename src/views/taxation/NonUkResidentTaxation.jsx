...
export default function NonUkResidentTaxation() {
          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-8 text-center text-lg-start">
              ...
              <p className="lead text-white-50 mb-4" style={{ maxWidth: '680px', fontSize: '1.1rem', lineHeight: 1.6 }}>
                {"Expert Tax Advice for Non-UK Residents with UK Income"}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row g-4">
            <div className="col-lg-7">
              ...
              <p className="lead text-secondary mb-4" style={{ lineHeight: 1.8 }}>
                {"Non-UK residents with UK property income, employment income, or investment returns face specific HMRC obligations. The Statutory Residence Test, double tax treaties, and the Non-Resident Landlord Scheme all interact in ways that require specialist advice."}
              </p>
              
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"Taxaccolega provides clear, practical advice on UK tax obligations for non-UK residents ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â whether you are a British expat living abroad, a foreign national with UK property, or an internationally mobile professional."}
              </p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="accordion custom-accordion shadow-sm rounded-4 overflow-hidden" id="faqAccordion">
                  ...
                  <FAQItem 
                    question={"Do I need to file a UK tax return if I live abroad?"} 
                    answer={"If you have UK-source income above certain thresholds (e.g. rental income, UK employment), you are generally required to file a UK Self Assessment tax return even if you are non-resident."} 
                    isOpen={openFaq === 0}
                  ...
                  <FAQItem 
                    ...
                    answer={"The SRT is the legal framework HMRC uses to determine whether an individual is UK-resident for tax purposes in a given tax year. It considers days spent in the UK and ties to the UK."} 
                    isOpen={openFaq === 1}
