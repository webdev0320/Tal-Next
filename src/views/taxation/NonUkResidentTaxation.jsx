          ...
          <div className="row g-5">
            <div className="col-lg-7">
              ...
              <p className="text-secondary mb-5" style={{ lineHeight: 1.8 }}>
                {"Taxaccolega provides clear, practical advice on UK tax obligations for non-UK residents Ã¢â‚¬â€ whether you are a British expat living abroad, a foreign national with UK property, or an internationally mobile professional."}
              </p>
