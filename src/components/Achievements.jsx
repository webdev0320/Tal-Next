        ...
        <div className="container py-4">
            <div className="row align-items-center g-5">
                <div className="col-lg-5 order-2 order-lg-1">
                    <LazyImage src="/images/2026/05/Award-Winning-768x765.webp" alt="Taxaccolega award winning recognitions and accreditations" width={768} height={765} className="rounded-4" />
                </div>
                <div className="col-lg-7 order-1 order-lg-2">
                    ...
                    <Link href="/awards-accolades-accreditations/" className="btn btn-brand btn-lg px-4 py-3">Achievements</Link>
                </div>
            </div>
        </div>
    </section>
