...
export default function OnlineAccountants() {
  return (
            ...
            <div className="row align-items-center g-5">
                <div className="col-lg-7">
                    ...
                    <a href="https://www.google.com/search?q=taxaccolega+google+reviews" target="_blank" rel="noreferrer" className="text-decoration-none d-inline-block">
                        <LazyImage src="/images/2023/06/Google-reviews-logo-taxaccolega-1024x157.png" alt="Taxaccolega 5-star Google reviews rating" width={300} height={46} className="rounded shadow-sm" />
                    </a>
                </div>
                <div className="col-lg-5">
                    <LazyImage
                        src="/images/2025/08/CEO--1024x715.webp"
                        alt="CEO of Taxaccolega chartered accountants"
                        width={1024}
                        height={715}
