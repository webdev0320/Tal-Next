          ...
          <div className="row g-4 align-items-center">
            <div className="col-12 col-md-3 text-center">
              {softwares[activeTab].img ? (
                <Image src={softwares[activeTab].img} alt={`${softwares[activeTab].title} accounting software`} width={200} height={120} className="rounded-3" style={{ objectFit: 'contain' }} />
              ) : (
